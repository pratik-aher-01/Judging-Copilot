...
3. Raises on failure — the orchestrator catches and logs, steps don't swallow errors silently
...
When adding a new step, wire it into orchestrator.py's sequence — don't call it standalone from app.py.